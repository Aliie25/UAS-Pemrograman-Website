...
$cek = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM testimoni WHERE komentar ='".$_POST['komentar']."'");
...
if( !empty($_FILES['gambar']['name']) )
    {
    $path = "gambar2/";
    $lastid=@mysqli_result(@mysqli_query($GLOBALS["___mysqli_ston"], "SELECT id_testimoni FROM testimoni ORDER BY id_testimoni DESC LIMIT 0,1"), 0, 0);
...
//echo "[ $qry_0.$qry_t ]";
$total_rec=@mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], $qry_0)); // *** TOTAL RECORD PRODUCT
