...
$total=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT id_produk FROM produk;"));
      ...
      $no++;
          ...
          $gambar="";
           ...
           echo "<td align='center'>".$gambar."</td>";
				   ...
				   echo "<td><a href=\"admin_product_edit.php?id=".$row['id_produk']."\"> <i class='fa fa-pencil' style='font-size: 20px;'></i>[EDIT]</a><td>";
           echo "<td><a href=\"admin_product_delete.php?id=".$row['id_produk']."\"><i class='fa fa-eraser' style='font-size: 20px;'></i>[DELETE]</a></td>";
			     echo "</tr>";
		}
    echo'
    </table>
