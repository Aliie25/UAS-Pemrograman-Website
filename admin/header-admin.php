...
if (!empty($_POST['username'])){
   ...
   $check=@mysqli_num_rows(@mysqli_query($GLOBALS["___mysqli_ston"], $sql));
...
<center>
<img src="../images/logoFix.png" width="200px" alt="" title=""><br>
<form method="post">
...
<ul>
  ...
  <li><a href="admin_order.php">Orderan</a></li>
